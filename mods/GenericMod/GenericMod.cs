...
namespace GenericMod
{
    ...
    {
        private const string ModId = "snowrabbit007.subnautica.GenericMod"; //same as in mod.json
        private const string ModName = "GenericMod";                        //same as in mod.json
        ...
        /// </summary>
        public static GenericModConfig Config { get; set; }
        ...
        {
            Config = YamlConfigReader.Readconfig<GenericModConfig>(
                ConfigFilePath,
                x => Console.WriteLine(
                    $"[{ModName}] [Fatal] Error parsing config file '{ConfigFilePath}': {x.Message} {Environment.NewLine}"));

            if (Config == null)
                return;

            Logger = new QModLogger(Config.LogLevel, "");
            Logger.AddLoggerTarget(new QModFileLoggerTarget(LogFilePath));
            Logger.AddLoggerTarget(new SubnauticaConsoleLoggerTarget(ModName));
            Logger.Open();
        ...
        {
            //TODO: Apply Patches and stuff here.
        ...
        public static void OnSceneStart()
        {
            ...
            //go.AddComponent<SomeImportantComponent>();
        }
        ...
        public static void OnSceneFinish()
        {
            ...
            //File.Write(SavePath, ImportantSaveInformation);
        }
